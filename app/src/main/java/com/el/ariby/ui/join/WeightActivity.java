...
public class WeightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_weight);
        ...
        mBinding.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(TextUtils.isEmpty(mBinding.etWeight.getText().toString()))) {
                    setPreference("weight", Integer.parseInt(mBinding.etWeight.getText().toString()));
                }else if(TextUtils.isEmpty(mBinding.etWeight.getText().toString())){
                    mBinding.etWeight.setError("필수 입력 항목입니다.");
                    return;
                }
