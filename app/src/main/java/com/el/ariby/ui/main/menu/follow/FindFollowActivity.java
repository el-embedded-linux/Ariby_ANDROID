...
public class FindFollowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextFilter = findViewById(R.id.find_follow);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (final DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    followingNum = String.valueOf(1);
                    followerNum = String.valueOf(2);
                    adapter.addItem(new FollowItem(url, nickname,followingNum,followerNum));
...
//    }
//
//    public void loadData1(final Callback callback) {
